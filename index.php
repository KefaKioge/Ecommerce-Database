<!---This is an HTML and PHP code for an e-commerce website that includes a navbar, product display, and category/brand filters. The code fetches products and categories/brands from a database and displays them on the website. It also includes a search function and a cart icon that shows the number of items in the cart. The website design uses Bootstrap and Font Awesome for styling-->
...
<li class="nav-item">
    <a class="nav-item">
        <a class ="nav-link" href ="./user_area/user_registration.php">Welcome Guest</a></li>
    <li class="nav-item">
    <a class="nav-item">
