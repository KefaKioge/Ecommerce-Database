    ...
    <div class="container-fluid">
        ...
        <!-- third child-->
            ...
            <div class="col-md-12 bg-secondary p-1 d-flex align-items center">
                <div class="p-3">
                    <a href="#"><img src="../images/pineapplejuice1.jfif" alt="" class="admi_image"></a>
                ...
                class="nav-link text-light bg-info my-1">
                Insert Categories
                </a>
                </button>
...
<div class="bg-warning p-3 text-center footer">
    <p>All Rights reserved © Designed and Powered by Kefa Kioge 2023</p>
</div>
</div>
